...
type relay struct {
	ID                       *int    `json:"id,omitempty"`                         // ID of the Switch component instance
...
// Some fields can have explicit null values, so they're not omitted
type input struct {
	ID              *int    `json:"id,omitempty"`            // ID of the Input component instance
...
type cloud struct {
	...
	Server *string `json:"server"`           // Name of the server to which the device is connected
}
